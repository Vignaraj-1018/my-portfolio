        ...
        <div className="flex flex-col gap-8" data-aos="fade-up" data-aos-duration='1000'>
            ...
            <div className="flex w-full justify-center items-center select-none">
                <div className="relative w-[35rem] pl-10 after:absolute after:inset-y-0 after:left-3 after:top-1 after:w-1 after:bg-black dark:after:bg-gray-600 flex flex-col gap-10">
                    <div className="flex flex-col text-sm relative">
                        ...
                        <div className="text-2xl font-extrabold">Sept 2025 - Present</div>
                        <div className="flex flex-col gap-2 text-xl font-bold">
                            <p className="flex">Software Engineer 1</p>
                            <p className="flex text-gray-500 dark:text-gray-400">Checkpoint Systems Software Pvt. Ltd.</p>
                            <p className="text-sm text-gray-500 dark:text-gray-400"><span className="font-semibold underline underline-offset-2">Tech Stack and Tools:</span> Azure Cloud, Docker, Kubernetes, ArgoCD, Ansible, Terraform, Nginx, BitBucket</p>
                            <li className="text-sm text-gray-500 dark:text-gray-400">Completed my internship as a DevOps Intern and transitioned into a Software Engineer I role, continuing to work with cloud-native technologies. Experienced in Docker, Kubernetes, Azure Cloud, Terraform, Ansible, and ArgoCD to automate infrastructure and streamline deployments.</li>
                        </div>
                    </div>
                </div>
            </div>
            <div className="flex w-full justify-center items-center select-none">
                <div className="relative w-[35rem] pl-10 after:absolute after:inset-y-0 after:left-3 after:top-1 after:w-1 after:bg-black dark:after:bg-gray-600 flex flex-col gap-10">
                    <div className="flex flex-col text-sm relative">
                        <div className="aspect-square w-6 bg-gray-900 rounded-full absolute -left-2 translate-x-[-29.5px] z-10 top-1 dark:bg-gray-50" />
                        <div className="text-2xl font-extrabold">Jan 2025 - Aug 2025</div>
                        <div className="flex flex-col gap-2 text-xl font-bold">
                            <p className="flex">Software Engineer Intern</p>
                            <p className="flex text-gray-500 dark:text-gray-400">Checkpoint Systems Software Pvt. Ltd.</p>
                            <p className="text-sm text-gray-500 dark:text-gray-400"><span className="font-semibold underline underline-offset-2">Tech Stack and Tools:</span> Azure Cloud, Docker, Kubernetes, ArgoCD, Ansible, Terraform, Nginx, BitBucket</p>
                            <li className="text-sm text-gray-500 dark:text-gray-400">Currently pursuing an internship as a DevOps Intern, working with cloud-native technologies like Docker, Kubernetes, Azure Cloud, Terraform, Ansible, and ArgoCD to automate infrastructure and streamline deployments.</li>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex w-full justify-center items-center select-none">
                <div className="relative w-[35rem] pl-10 after:absolute after:inset-y-0 after:left-2 after:top-1 after:w-1 after:bg-black dark:after:bg-gray-600 flex flex-col gap-10">
                    <div className="flex flex-col text-sm relative">
                        ...
                        <div className="text-2xl font-extrabold">2020 - 2025</div>
                        <div className="flex flex-col gap-2 text-xl font-bold">
                            <p className="flex">M.Sc. Software Systems</p>
                            <p className="flex text-gray-500 dark:text-gray-400">CGPA: 8.63</p>
