...
const DayNames = {
  ...
  function Cell({ color, dataPoint }) {
    ...
    return (
      <div className='timeline-cells-cell' style={style} title={`${dataPoint.value} submissions on ${dataPoint.date.format('MMMM DD, YYYY')}`}></div>
    )
  }
